#!/usr/bin/env python3
"""GD Voice v5 Test - Long sentences (best quality version)"""
...
MODEL_PATH = "/home/nexus/connect/server/finetune/models/gd-voice-v5/checkpoint-epoch-final"
OUTPUT_DIR = "/home/nexus/connect/server/finetune/output/v5_long_test"
...
TEST_TEXTS = [
    ...
    "저는 항상 새로운 것에 도전하는 것을 좋아합니다. 음악, 패션, 예술 모든 분야에서 끊임없이 변화하고 성장하고 싶습니다.",
]
...
def main():
    print("=" * 60)
    print("GD Voice v5 Test - Long Sentences (Best Quality)")
    print("=" * 60)
